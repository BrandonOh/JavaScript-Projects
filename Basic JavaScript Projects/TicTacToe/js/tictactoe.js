...
function placeXOrO(squareNumber) {
  ...
  if (!selectedSquares.some((element) => element.includes(squareNumber))) {
    ...
    if (activePlayer === "X") {
      //If activePlayer is equal to "X", the Mushroom.png is placed in HTML.
      select.style.backgroundImage = 'url("./images/Mushroom.png")';
      //Active player may only be "X" or "O" so, if not "X" it must be "O"
    } else {
      //If activePlayer is equal to "O", the Fire_Flower.png is placed in HTML.
      select.style.backgroundImage = 'url("./images/Fire_Flower.png")';
    }
...
function checkWinConditions() {
  ...
  //This function checks if an array includes 3 strings. It is ued to check for
  //each win condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
  ...
  let x1 = coordX1,
    ...
    x2 = coordX2,
    //This line indicates where the end of the line y axis is.
    y2 = coordY2,
